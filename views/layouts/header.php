...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="<?= BASE_URL ?>">Gestión de Tareas</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <?php if ($isAuthenticated): ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?= BASE_URL ?>/tareas">Tareas</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?= BASE_URL ?>/stats">Estadísticas</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?= BASE_URL ?>/config">Configuración</a>
                        </li>
                    <?php endif; ?>
                </ul>
                <?php if ($isAuthenticated): ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <?php if ($userRole === 'admin'): ?>
                                    <li><a class="dropdown-item" href="<?= BASE_URL ?>/admin/tareas">
                                            <i class="fas fa-cogs"></i> Administración de Tareas
                                        </a></li>
                                <?php endif; ?>
                                <li>
